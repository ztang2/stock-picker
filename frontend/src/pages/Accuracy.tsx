    ...
    <div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-6">
        <div className="p-3.5 rounded-lg bg-surface border border-border">
          <div className="text-[10px] font-semibold text-text-muted uppercase tracking-widest">Win Rate</div>
        ...
        <div className="p-3.5 rounded-lg bg-surface border border-border">
          <div className="text-[10px] font-semibold text-text-muted uppercase tracking-widest">Avg Return</div>
        ...
        <div className="p-3.5 rounded-lg bg-surface border border-border">
          <div className="text-[10px] font-semibold text-text-muted uppercase tracking-widest">Avg Alpha</div>
        ...
        <div className="p-3.5 rounded-lg bg-surface border border-border">
          <div className="text-[10px] font-semibold text-text-muted uppercase tracking-widest">Buy Signals</div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        {data.best_pick && (
          <div className="p-4 rounded-lg bg-surface border border-border">
            <div className="text-[10px] font-semibold text-text-muted uppercase tracking-widest mb-2">Best Pick</div>
        ...
        {data.worst_pick && (
          <div className="p-4 rounded-lg bg-surface border border-border">
            <div className="text-[10px] font-semibold text-text-muted uppercase tracking-widest mb-2">Worst Pick</div>
